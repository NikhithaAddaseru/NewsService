...
//		.withUser("10").password("publisher").roles("PUBLISHER");
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/news/deleteInValidArticles").hasAnyAuthority("ADMIN")
		...
		.antMatchers("/news/editArticle/{newsId}").hasAnyAuthority("PUBLISHER", "ADMIN")
		.antMatchers("/news/publishArticle/{newsId}").hasAnyAuthority("PUBLISHER", "ADMIN")
		.antMatchers("/news/viewArticle/{newsId}").hasAnyAuthority("USER", "ADMIN","PUBLISHER")
